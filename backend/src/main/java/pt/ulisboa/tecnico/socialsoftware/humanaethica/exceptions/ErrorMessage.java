...
public enum ErrorMessage {
    ...
    // Volunteer Profile
    VOLUNTEERPROFILE_REQUIRES_SHORTBIO("The volunteer's short bio must contain at least 10 characters."),
    VOLUNTEERPROFILE_REQUIRES_ALL_SELECTED_PARTICIPATIONS_MUST_BE_ASSESSED("All selected participations must be assessed."),
    VOLUNTEERPROFILE_REQUIRES_VALID_NUMBER_OF_SELECTED_PARTICIPATIONS("The number of selected participations (ns) must be at least the minimum of: 1) the total number of assessed participations (ta); 2) half of the total number of participations (tp). Formally: ns >= min(tp/2, ta)."),
    VOLUNTEERPROFILE_NOT_FOUND("Volunteer Profile not found."),
    VOLUNTEERPROFILE_INVALID_ARGUMENT("Invalid argument."),
    ;

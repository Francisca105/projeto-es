...
public class UserController {
    ...
    @PostMapping("/volunteers/{userId}/profile")
    @PreAuthorize("(hasRole('ROLE_VOLUNTEER'))")
    public VolunteerProfileDto createVolunteerProfile(@PathVariable Integer userId, @Valid @RequestBody VolunteerProfileDto volunteerProfileDto) {
        return userService.createVolunteerProfile(userId, volunteerProfileDto);
    }

    @GetMapping("/volunteers/{userId}/profile")
    public VolunteerProfileDto getVolunteerProfile(@PathVariable Integer userId) {
        return userService.getVolunteerProfile(userId);
    }
}
